import {PasswordAuthMiddlewareOptions, UserAuthOptions} from "@commercetools/sdk-client-v2";
import {configService} from "../../services/config.service.ts";
import {tokenCacheUtil} from "../../utils";

export const passwordMiddleware = (user: UserAuthOptions): PasswordAuthMiddlewareOptions => ({
