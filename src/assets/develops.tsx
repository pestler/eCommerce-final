...
const Develops = [
  ...
  },
  {
    ...
    about: 'Я работаю ведущим инженером в банке. Мои навыки это HTML CSS PL/SQL JavaScript. Закончила Пермский государственный технический университет -  информатика - системы автоматизации обработки данных и управления',
  ...
  },
  {
    ...
    about: 'Я любознательный и трудолюбивый человек. Я постоянно учусь и совершенствую свои навыки каждый день. У меня есть опыт разработки клиентской и серверной части приложений, работы с базами данных, создания SPA-приложений. Способен эффективно управлять собой во время выполнения независимых проектов, а также сотрудничать в составе продуктивной команды.',
